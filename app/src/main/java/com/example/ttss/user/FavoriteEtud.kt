...
class FavoriteEtud : Fragment(),UserAdapter.OnItemClickListener {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        pref = view.getContext().getSharedPreferences("application_preference",
        ...
        viewModel.getAllFavorites(1).observe(this, Observer {
                books->
    ...
    override fun onItemLongClick(view: RowUserBinding, booksWithFavorite: BooksWithFavorite) {
        onDetailsClick(booksWithFavorite)
    }
